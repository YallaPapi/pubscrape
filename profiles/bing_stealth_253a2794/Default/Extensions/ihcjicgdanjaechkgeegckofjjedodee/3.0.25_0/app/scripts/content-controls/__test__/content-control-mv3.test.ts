...
import { getNextDynamicRuleId } from "@/app/scripts/mv3/dynamic-rule-utils";
...
describe("Mv3ContentControls", () => {
    ...
    test("should add item and update dynamic rules", async () => {        
        (getNextDynamicRuleId as any).mockResolvedValue(2);
    ...
    test("should import content control list", async () => {
        (getNextDynamicRuleId as any).mockResolvedValue(1);
