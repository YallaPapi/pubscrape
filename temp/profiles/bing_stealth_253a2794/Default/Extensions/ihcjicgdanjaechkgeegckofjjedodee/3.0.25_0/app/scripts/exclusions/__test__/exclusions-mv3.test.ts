...
import {
    getNextDynamicRuleId,
    getNextSessionRuleId,
...
jest.mock("@/app/scripts/mv3/dynamic-rule-utils", () => {
    ...
    return {
        ...
        getNextDynamicRuleId: jest.fn(() => Promise.resolve(1000)), // Mock only this function
        getNextSessionRuleId: jest.fn(() => Promise.resolve(1000)),
