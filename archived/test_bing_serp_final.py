#!/usr/bin/env python3
"""
FINAL WORKING Bing SERP retrieval with Botasaurus
Corrected to use properties instead of methods
"""
...
def bing_serp_retrieval_final(driver, search_data):
    """
    WORKING Bing SERP retrieval using CORRECT Botasaurus API
    Uses properties not methods for page_html, user_agent, etc.
    """
    try:
        ...
        # Get page content using PROPERTIES not methods
        title = driver.title
        ...
        if is_blocked or not has_results or len(page_html) < 5000:
            ...
            title = driver.title
            current_url = driver.current_url
            page_html = driver.page_html  # Property!
...
def test_final_bing_serp():
    """Test the FINAL working Bing SERP function"""
    print("=" * 70)
    print("TESTING FINAL WORKING BING SERP RETRIEVAL")
    print("=" * 70)
    ...
    for i, query in enumerate(test_queries, 1):
        ...
        result = bing_serp_retrieval_final(search_data)
        ...
        if result['success']:
            ...
            print(f"  User agent: {result['user_agent_used'][:50]}...")
    ...
    print("\n" + "=" * 70)
    print("BING SERP TEST COMPLETE - READY FOR INTEGRATION!")
    print("=" * 70)
